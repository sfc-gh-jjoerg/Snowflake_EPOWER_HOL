-- ========================================================================
-- Module 2: EPOWER VPP Monitor - Cleanup Script
-- ========================================================================
-- Removes the Snowflake App and all associated objects created by Module 2.
...
-- NOTE: These views are managed by dbt (epower_dbt/models/epulse_vpp/presentation/).
-- Running this cleanup removes them. Re-run 'dbt run' to restore them if needed.
...
SELECT 'Module 2 (VPP Monitor) cleanup completed!' AS status;
