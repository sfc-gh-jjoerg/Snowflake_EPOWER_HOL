SELECT
    ...
    ROUND(SUM(grid_import_kw), 2)  AS total_grid_import_kwh,
    ROUND(SUM(grid_export_kw), 2)  AS total_grid_export_kwh,
    ROUND(SUM(grid_import_kw) - SUM(grid_export_kw), 2) AS net_grid_kwh
